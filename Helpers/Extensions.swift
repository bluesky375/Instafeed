...
//        globeButton.backgroundColor = UIColor(red: 171/255, green: 178/255, blue: 186/255, alpha: 1.0)
    ...
    func roundedButton(bgColor: UIColor) {
        ...
        maskLayer1.fillColor = bgColor.cgColor
        maskLayer1.shadowColor = UIColor.lightGray.cgColor
        maskLayer1.shadowPath = maskLayer1.path
        maskLayer1.shadowOffset = CGSize(width: 2.0, height: 2.0)
        maskLayer1.shadowOpacity = 0.8
        maskLayer1.shadowRadius = 2
        //        maskLayer1.masksToBounds = true
        
        //        layer.mask = maskLayer1
        //        layer.insertSublayer(maskLayer1, at: 0)
        layer.insertSublayer(maskLayer1, below: self.imageView?.layer)
    }
